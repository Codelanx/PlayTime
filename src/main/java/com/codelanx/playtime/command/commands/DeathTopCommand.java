...
public class DeathTopCommand implements CommandBase {
	...
	public boolean execute(CommandSender sender, Command cmd, String commandLabel, String[] args) {
        ...
        if (players == null) {
            sender.sendMessage(Playtime.__(this.plugin.getCipher().getString("command.commands.deathtop.disabled-flatfile")));
            return true;
        }
        if (scoreboard) {
            Player p = (Player)sender;
            ...
            p.sendMessage(Playtime.__(this.plugin.getCipher().getString("command.commands.deathtop.clear")));
